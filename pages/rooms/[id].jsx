  ...
  return (
    <div className={"flex justify-center z-0 " + style.background}>
      ...
      <div
        className={
          style.content +
          " z-1 w-[60vw] h-[88.5vh] py-5 flex flex-col justify-between items-center "
        }
      >
        ...
        <div
          className={"drop-shadow hover:shadow-lg mt-[-1.5vh] " + style.form}
        >
          <div className="ml-[20vh] grid grid-cols-2 px-2 justify-center ">
            ...
            <div clasName="grid grid-cols-2 ">
              <p
                className={
                  style.facilities +
                  "justify-center text-s max-w-[35vh] mt-[2vh]"
                }
              >
                {data[0].facilities}
              </p>
        ...
        <div
          className={
            "mt-[0.5vh] max-w-[90vh] max-h-[15vh] drop-shadow hover:shadow-lg " +
            style.form
          }
        >
          {/* check in date*/}
          <div className="grid grid-cols-2 px-1">
            <div className="grid grid-cols-1 mr-[2vh] bg-blue-500">
              <p className=" text-lg bold text-black">Check-in Date</p>
              <DatePicker
            ...
            <div className=" grid grid-cols-1 ml-[2vh] bg-red-500">
              <p className="text-lg bold text-black">Check-out Date</p>
              <DatePicker
                className="border-black z-10"
                selected={checkOut}
        ...
        <div
          className={
            "z-0 mt-[0.5vh] w-[vh] h-[15vh] drop-shadow hover:shadow-lg " +
            style.form
          }
        >
          <div className="mt-[-2vh]">
            <p className="text-lg bold">Rp. subtotal</p>
          </div>
          <button
            className="z-1 rounded-lg hover:bg-gray-400 hover:text-black text-sm"
