    ...
    <section>
        <div className="grid grid-cols-1 max-h-[90vh] overflow-hidden">
            ...
            <div className="grid grid-co-3">
                <button className="absolute left-[9.5vw] top-[480px] h-[5vw] w-[29vw] bg-[#7F6F62] hover:bg-white  text-white font-semibold hover:text-black py-2 px-4 border border-black hover:border-[#7F6F62] rounded-xl"
